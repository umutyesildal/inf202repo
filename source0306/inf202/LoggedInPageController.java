...
{
    //note that on this line you can substitue "Screen2.fxml" for a string chosen prior to this line.
    Parent loader = FXMLLoader.load(getClass().getResource("Operatoren.fxml"));//Creates a Parent called loader and assign it as ScReen2.FXML
    ...
    app_stage.show(); // this shows the scene
        ...
        public void buttonclickedFirmen(ActionEvent event) throws IOException //This method loads a new scene in a current window
{
    //note that on this line you can substitue "Screen2.fxml" for a string chosen prior to this line.
    Parent loader = FXMLLoader.load(getClass().getResource("Firmen.fxml"));//Creates a Parent called loader and assign it as ScReen2.FXML
